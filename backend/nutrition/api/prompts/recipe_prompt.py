...
#
# INTERACTIVE_STEP_INSTRUCTIONS = Each assembly_step "action" MUST begin with one of these verbs (the cooking lab
# uses them to decide which kitchen tool to highlight):
#
#   chop / slice / dice / cut  →  cutting board
#   fry / sauté / cook / pour  →  stovetop pan
...
#
# Good example:
#   {"step":1,"action":"pour oil into pan","ingredient":"oil","tip":"use medium heat"}
#   {"step":2,"action":"chop finely","ingredient":"onion","tip":"smaller pieces cook faster"}
#   {"step":3,"action":"fry until soft","ingredient":"onion","tip":"about 3 minutes"}
#   {"step":4,"action":"stir in spices","ingredient":"cumin","tip":"toast briefly"}
#   {"step":5,"action":"mix everything together","ingredient":"lentils","tip":"add cooked lentils last"}
#
# Return JSON in EXACTLY this shape:
# {{
#   "recipes": [
